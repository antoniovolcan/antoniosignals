...
- **`learningRate=0.001` (ajuste muy suave): 56.04% temporada completa** (Mar-Jun 55.94%, Jul-Sep 56.14%) — apenas +0.04pp sobre el baseline de 55.99%, dentro del ruido para n=2427. Los parámetros oscilan levemente alrededor de los valores de producción y nunca se alejan mucho (`homeFieldBonus` termina en 0.084 vs el 0.09 de partida).
...
- **`learningRate=0.02` (agresivo): 55.21% temporada completa** (Mar-Jun 56.02%, Jul-Sep 54.33%) — el peor de los tres, y con oscilación visible en vez de convergencia: `homeFieldBonus` salta 0.09→0.128→0.082→0.043→0.059→0.065→0.055 juego a juego en las muestras de trayectoria, sin asentarse. La mitad Jul-Sep se degrada más de 1.6pp respecto al baseline.
